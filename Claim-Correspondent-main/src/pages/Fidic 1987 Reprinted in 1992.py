...
st.set_page_config(page_title="FIDIC 1992", page_icon=im, layout="wide")
...
ASSISTANT_ID = "asst_nus5yZQuWWIJiX6Hv2CIMtjy"
...
st.title("Claim Correspondent FIDIC 1987 Reprinted in 1992")
